# zpower/stabilize/model_stabilizer.py  —  ModelStabilizer v1.3.0
# v1.3: Added __repr__
...
class ModelStabilizer:
    """ModelStabilizer v1.3.0 — Unified GradShield + StabilityCore."""
    ...
    def __repr__(self) -> str:
        return f"ModelStabilizer(grad_shield={self.grad_shield}, stability_core={self.stability_core})"
